...
fishing_minigame_whirlpool_animation:
    ...
    debug: false
    script:
        - define circles <server.flag[fishing_minigame_active_whirlpool_locations].keys.parse[above[0.5]]>
        - while !<server.has_flag[fishing_minigame_reset_whirlpools]>:
            - playeffect at:<[circles]> dolphin quantity:50 offset:0.5,0.2,0.5 targets:<server.flag[fishingminingame.activeplayers]>
            - wait 1t
        - flag server fishing_minigame_reset_whirlpools:!
