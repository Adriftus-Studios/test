...
big_shulker_events:
  ...
  events:
    ...
    - flag <[item]> big_shulker_title:<context.location.block.flag[big_shulker_title]> if:<context.location.block.has_flag[big_shulker_title]>
    - define item <[item].with[display=<context.location.block.flag[big_shulker_title]>]> if:<context.location.block.has_flag[big_shulker_title]>
    ...
    - adjust <[inv]> title:<context.location.block.flag[big_shulker_title].if_null[<[inv].title>]>
    ...
    - flag <context.location.block> big_shulker_title:<context.item_in_hand.flag[big_shulker_title]> if:<context.item_in_hand.has_flag[big_shulker_title]>