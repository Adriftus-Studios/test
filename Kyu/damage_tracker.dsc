...
damage_tracker_taken:
  ...
  debug: false
  script:
    - define text "<&4><&gt><&c><context.final_damage.round_to[1]><tern[<context.was_critical>].pass[<&7>*].fail[<&r>]><&4><&lt>"
...
damage_tracker_dealt:
  ...
  debug: false
  script:
    - define text "<&6><&lt><&e><context.final_damage.round_to[1]><tern[<context.was_critical>].pass[<&7>*].fail[<&r>]><&6><&gt>"
    - actionbar <[text]> targets:<player> per_player
