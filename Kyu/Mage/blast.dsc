...
impl_skill_blast_task:
  ...
  definitions: target
  script:
    - push <[target].location.find.living_entities.within[<script[impl_skill_blast_icon].parsed_key[balance.radius]>].remove[<player>]> destination:<[target].location.backward_flat[2].above[2]> no_rotate
    - determine true
