    ...
    on click:
      - if <player.item_in_hand.has_flag[bank_note]>:
        ...
        - else:
          ...
          - wait 3s
          - repeat 5:
            - title title:<&1><&font[adriftus:overlay]><&chr[1001]><&chr[F801]><&chr[1001]> "subtitle:The Police Have Been Alerted" fade_in:1t stay:1.5s fade_out:1t
            - wait 1s
            - title title:<&4><&font[adriftus:overlay]><&chr[1001]><&chr[F801]><&chr[1001]> "subtitle:The Police Have Been Alerted" fade_in:1t stay:1.5s fade_out:1t
            - wait 1s
      - else:
