fun_fireball:
  ...
  - define map.1 <proc[define_curve1].context[<player.eye_location>|<player.eye_location.forward[3]>|2|45|0.3]>
  - define map.2 <proc[define_curve1].context[<player.eye_location>|<player.eye_location.forward[3]>|2|-90|0.3]>
  - define map.3 <proc[define_curve1].context[<player.eye_location>|<player.eye_location.forward[3]>|2|135|0.3]>
