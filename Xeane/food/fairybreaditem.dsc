custom_food_fairybread:
  type: item
  debug: false
  material: apple
  display name: <&a>Fairy Bread
  data:
    amount: 12
    saturation: 14
  lore:
