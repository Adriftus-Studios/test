...
open_portal:
  ...
  script:
    ...
    - adjust <[target]> exit_location:<[destination]>
    - adjust <[target].above> exit_location:<[destination]>
    - adjust <[target]> is_exact_teleport:true
    - adjust <[target].above> is_exact_teleport:true
    - flag <[target]> destination:<[destination]>
    - flag <[target].above> destination:<[destination]>
