message_command:
  ...
  script:
    ...
    # Whisper Channel
    - define WhisperTextSelf "<&7><&lb>MSG<&rb><&r><&e>You<&b>-<&gt><&e><context.args.get[1].to_titlecase><&co> "
    - define WhisperTextOther "<&7><&lb>MSG<&rb><&r><&e><proc[get_player_display_name]><&b>-<&gt><&e>You<&co> "
    ...
    - run bungee_send_message def:<server.has_flag[player_map.names.<context.args.get[1]>.uuid]>|<[message]>
